...
const G_EXCL: Glyph = Glyph { strokes: &[
    &[(12, 28), (12, 8)],
    &[(12, 4), (12, 0)],
] };
const G_QUOTE: Glyph = Glyph { strokes: &[
    &[(8, 28), (8, 22)],
    &[(16, 28), (16, 22)],
] };
const G_HASH: Glyph = Glyph { strokes: &[
    &[(8, 28), (8, 0)],
    &[(16, 28), (16, 0)],
    &[(4, 20), (20, 20)],
    &[(4, 8), (20, 8)],
] };
const G_DOLLAR: Glyph = Glyph { strokes: &[
    &[(20, 24), (4, 24), (4, 16), (20, 12), (20, 4), (4, 4)],
    &[(12, 30), (12, -2)],
] };
const G_PERCENT: Glyph = Glyph { strokes: &[
    &[(4, 0), (20, 28)],
    &[(6, 28), (10, 28), (10, 24), (6, 24), (6, 28)],
    &[(14, 4), (18, 4), (18, 0), (14, 0), (14, 4)],
] };
const G_AMP: Glyph = Glyph { strokes: &[
    &[(20, 0), (4, 16), (4, 24), (12, 28), (16, 24), (16, 18),
      (4, 8), (4, 4), (8, 0), (16, 0), (20, 4)],
] };
const G_APOS: Glyph = Glyph { strokes: &[
    &[(12, 28), (12, 22)],
] };
const G_LPAREN: Glyph = Glyph { strokes: &[
    &[(16, 32), (8, 24), (8, 4), (16, -4)],
] };
const G_RPAREN: Glyph = Glyph { strokes: &[
    &[(8, 32), (16, 24), (16, 4), (8, -4)],
] };
const G_STAR: Glyph = Glyph { strokes: &[
    &[(12, 24), (12, 8)],
    &[(4, 20), (20, 12)],
    &[(20, 20), (4, 12)],
] };
const G_PLUS: Glyph = Glyph { strokes: &[
    &[(12, 22), (12, 6)],
    &[(4, 14), (20, 14)],
] };
const G_COMMA: Glyph = Glyph { strokes: &[
    &[(12, 4), (12, 0), (8, -4)],
] };
const G_MINUS: Glyph = Glyph { strokes: &[
    &[(4, 14), (20, 14)],
] };
const G_DOT: Glyph = Glyph { strokes: &[
    &[(12, 4), (12, 0)],
] };
const G_SLASH: Glyph = Glyph { strokes: &[
    &[(4, 0), (20, 28)],
] };

// Digits.
const G_0: Glyph = Glyph { strokes: &[
    &[(8, 0), (4, 4), (4, 24), (8, 28), (16, 28), (20, 24),
      (20, 4), (16, 0), (8, 0)],
    &[(4, 4), (20, 24)],
] };
const G_1: Glyph = Glyph { strokes: &[
    &[(8, 22), (12, 28), (12, 0)],
    &[(6, 0), (18, 0)],
] };
const G_2: Glyph = Glyph { strokes: &[
    &[(4, 24), (8, 28), (16, 28), (20, 24), (20, 18), (4, 0), (20, 0)],
] };
const G_3: Glyph = Glyph { strokes: &[
    &[(4, 24), (8, 28), (16, 28), (20, 24), (20, 18), (16, 14), (8, 14)],
    &[(16, 14), (20, 10), (20, 4), (16, 0), (8, 0), (4, 4)],
] };
const G_4: Glyph = Glyph { strokes: &[
    &[(16, 0), (16, 28), (4, 10), (20, 10)],
] };
const G_5: Glyph = Glyph { strokes: &[
    &[(20, 28), (4, 28), (4, 16), (16, 16), (20, 12), (20, 4),
      (16, 0), (8, 0), (4, 4)],
] };
const G_6: Glyph = Glyph { strokes: &[
    &[(20, 24), (16, 28), (8, 28), (4, 24), (4, 4), (8, 0),
      (16, 0), (20, 4), (20, 12), (16, 16), (4, 16)],
] };
const G_7: Glyph = Glyph { strokes: &[
    &[(4, 28), (20, 28), (8, 0)],
] };
const G_8: Glyph = Glyph { strokes: &[
    &[(8, 28), (4, 24), (4, 18), (8, 14), (16, 14), (20, 18),
      (20, 24), (16, 28), (8, 28)],
    &[(8, 14), (4, 10), (4, 4), (8, 0), (16, 0), (20, 4),
      (20, 10), (16, 14)],
] };
const G_9: Glyph = Glyph { strokes: &[
    &[(4, 4), (8, 0), (16, 0), (20, 4), (20, 24), (16, 28),
      (8, 28), (4, 24), (4, 16), (8, 12), (20, 12)],
] };

const G_COLON: Glyph = Glyph { strokes: &[
    &[(12, 18), (12, 14)],
    &[(12, 4), (12, 0)],
] };
const G_SEMI: Glyph = Glyph { strokes: &[
    &[(12, 18), (12, 14)],
    &[(12, 4), (12, 0), (8, -4)],
] };
const G_LT: Glyph = Glyph { strokes: &[
    &[(20, 22), (4, 14), (20, 6)],
] };
const G_EQ: Glyph = Glyph { strokes: &[
    &[(4, 18), (20, 18)],
    &[(4, 10), (20, 10)],
] };
const G_GT: Glyph = Glyph { strokes: &[
    &[(4, 22), (20, 14), (4, 6)],
] };
const G_QUESTION: Glyph = Glyph { strokes: &[
    &[(4, 24), (8, 28), (16, 28), (20, 24), (20, 18), (12, 12), (12, 8)],
    &[(12, 4), (12, 0)],
] };
const G_AT: Glyph = Glyph { strokes: &[
    &[(20, 8), (16, 4), (8, 4), (4, 8), (4, 20), (8, 24),
      (16, 24), (20, 20), (20, 8), (16, 8), (14, 12), (14, 18),
      (12, 20), (10, 18), (10, 12), (12, 10), (16, 10)],
] };

// Uppercase A-Z.
const G_A: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 22), (12, 28), (20, 22), (20, 0)],
    &[(4, 12), (20, 12)],
] };
const G_B: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (16, 28), (20, 24), (20, 18), (16, 14),
      (4, 14)],
    &[(16, 14), (20, 10), (20, 4), (16, 0), (4, 0)],
] };
const G_C: Glyph = Glyph { strokes: &[
    &[(20, 24), (16, 28), (8, 28), (4, 24), (4, 4), (8, 0),
      (16, 0), (20, 4)],
] };
const G_D: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (14, 28), (20, 22), (20, 6), (14, 0), (4, 0)],
] };
const G_E: Glyph = Glyph { strokes: &[
    &[(20, 28), (4, 28), (4, 0), (20, 0)],
    &[(4, 14), (16, 14)],
] };
const G_F: Glyph = Glyph { strokes: &[
    &[(20, 28), (4, 28), (4, 0)],
    &[(4, 14), (16, 14)],
] };
const G_G: Glyph = Glyph { strokes: &[
    &[(20, 24), (16, 28), (8, 28), (4, 24), (4, 4), (8, 0),
      (16, 0), (20, 4), (20, 12), (12, 12)],
] };
const G_H: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28)],
    &[(20, 0), (20, 28)],
    &[(4, 14), (20, 14)],
] };
const G_I: Glyph = Glyph { strokes: &[
    &[(8, 0), (16, 0)],
    &[(12, 0), (12, 28)],
    &[(8, 28), (16, 28)],
] };
const G_J: Glyph = Glyph { strokes: &[
    &[(20, 28), (20, 4), (16, 0), (8, 0), (4, 4)],
] };
const G_K: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28)],
    &[(20, 28), (4, 14), (20, 0)],
] };
const G_L: Glyph = Glyph { strokes: &[
    &[(4, 28), (4, 0), (20, 0)],
] };
const G_M: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (12, 14), (20, 28), (20, 0)],
] };
const G_N: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (20, 0), (20, 28)],
] };
const G_O: Glyph = Glyph { strokes: &[
    &[(8, 0), (4, 4), (4, 24), (8, 28), (16, 28), (20, 24),
      (20, 4), (16, 0), (8, 0)],
] };
const G_P: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (16, 28), (20, 24), (20, 18), (16, 14),
      (4, 14)],
] };
const G_Q: Glyph = Glyph { strokes: &[
    &[(8, 0), (4, 4), (4, 24), (8, 28), (16, 28), (20, 24),
      (20, 4), (16, 0), (8, 0)],
    &[(14, 6), (22, -2)],
] };
const G_R: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 28), (16, 28), (20, 24), (20, 18), (16, 14),
      (4, 14)],
    &[(12, 14), (20, 0)],
] };
const G_S: Glyph = Glyph { strokes: &[
    &[(20, 24), (16, 28), (8, 28), (4, 24), (4, 18), (8, 14),
      (16, 14), (20, 10), (20, 4), (16, 0), (8, 0), (4, 4)],
] };
const G_T: Glyph = Glyph { strokes: &[
    &[(4, 28), (20, 28)],
    &[(12, 28), (12, 0)],
] };
const G_U: Glyph = Glyph { strokes: &[
    &[(4, 28), (4, 4), (8, 0), (16, 0), (20, 4), (20, 28)],
] };
const G_V: Glyph = Glyph { strokes: &[
    &[(4, 28), (12, 0), (20, 28)],
] };
const G_W: Glyph = Glyph { strokes: &[
    &[(4, 28), (8, 0), (12, 14), (16, 0), (20, 28)],
] };
const G_X: Glyph = Glyph { strokes: &[
    &[(4, 28), (20, 0)],
    &[(4, 0), (20, 28)],
] };
const G_Y: Glyph = Glyph { strokes: &[
    &[(4, 28), (12, 14), (20, 28)],
    &[(12, 14), (12, 0)],
] };
const G_Z: Glyph = Glyph { strokes: &[
    &[(4, 28), (20, 28), (4, 0), (20, 0)],
] };

const G_LBRACK: Glyph = Glyph { strokes: &[
    &[(16, 32), (8, 32), (8, -4), (16, -4)],
] };
const G_BACKSLASH: Glyph = Glyph { strokes: &[
    &[(4, 28), (20, 0)],
] };
const G_RBRACK: Glyph = Glyph { strokes: &[
    &[(8, 32), (16, 32), (16, -4), (8, -4)],
] };
const G_CARET: Glyph = Glyph { strokes: &[
    &[(4, 22), (12, 30), (20, 22)],
] };
const G_UNDER: Glyph = Glyph { strokes: &[
    &[(0, -2), (24, -2)],
] };
const G_BACKTICK: Glyph = Glyph { strokes: &[
    &[(8, 30), (14, 24)],
] };
...
const G_b: Glyph = Glyph { strokes: &[
    &[(4, 28), (4, 0), (16, 0), (20, 4), (20, 14), (16, 18),
      (8, 18), (4, 14)],
] };
const G_c: Glyph = Glyph { strokes: &[
    &[(20, 14), (16, 18), (8, 18), (4, 14), (4, 4), (8, 0),
      (16, 0), (20, 4)],
] };
const G_d: Glyph = Glyph { strokes: &[
    &[(20, 28), (20, 0), (8, 0), (4, 4), (4, 14), (8, 18),
      (16, 18), (20, 14)],
] };
const G_e: Glyph = Glyph { strokes: &[
    &[(4, 8), (20, 8), (20, 14), (16, 18), (8, 18), (4, 14),
      (4, 4), (8, 0), (16, 0), (20, 4)],
] };
const G_f: Glyph = Glyph { strokes: &[
    &[(20, 28), (12, 28), (8, 24), (8, 0)],
    &[(4, 14), (16, 14)],
] };
const G_g: Glyph = Glyph { strokes: &[
    &[(20, 18), (4, 18), (4, 8), (20, 8)],
...
const G_n: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 18), (8, 18), (20, 4), (20, 0)],
] };
const G_o: Glyph = Glyph { strokes: &[
    &[(8, 0), (4, 4), (4, 14), (8, 18), (16, 18), (20, 14),
      (20, 4), (16, 0), (8, 0)],
] };
const G_p: Glyph = Glyph { strokes: &[
    &[(4, -8), (4, 18), (16, 18), (20, 14), (20, 4), (16, 0),
      (8, 0), (4, 4)],
] };
const G_q: Glyph = Glyph { strokes: &[
    &[(20, -8), (20, 18), (8, 18), (4, 14), (4, 4), (8, 0),
      (16, 0), (20, 4)],
] };
const G_r: Glyph = Glyph { strokes: &[
    &[(4, 0), (4, 18)],
...
const G_s: Glyph = Glyph { strokes: &[
    &[(20, 14), (16, 18), (8, 18), (4, 14), (8, 8), (16, 8),
      (20, 4), (16, 0), (8, 0), (4, 4)],
] };
const G_t: Glyph = Glyph { strokes: &[
    &[(8, 28), (8, 4), (12, 0), (20, 0)],
...
const G_LBRACE: Glyph = Glyph { strokes: &[
    &[(20, 32), (16, 28), (16, 18), (12, 14), (16, 10), (16, 0), (20, -4)],
] };
const G_PIPE: Glyph = Glyph { strokes: &[
    &[(12, 32), (12, -4)],
] };
const G_RBRACE: Glyph = Glyph { strokes: &[
    &[(4, 32), (8, 28), (8, 18), (12, 14), (8, 10), (8, 0), (4, -4)],
] };
const G_TILDE: Glyph = Glyph { strokes: &[
    &[(4, 14), (8, 18), (16, 10), (20, 14)],
] };
